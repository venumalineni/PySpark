...
df.write.parquet(r'C:\Users\vmalineni\Documents\mywork\PySpark_Learning\Partition_by', mode='overwrite', partitionBy='team')

spark.read.parquet(r'C:\Users\vmalineni\Documents\mywork\PySpark_Learning\Partition_by\team=OSKAR').show()