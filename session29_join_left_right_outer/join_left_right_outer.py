...
empDF.join(teamDF, empDF.id==teamDF.id, 'inner').show()
empDF.join(teamDF, empDF.id==teamDF.id, 'left').show()
empDF.join(teamDF, empDF.id==teamDF.id, 'right').show()
empDF.join(teamDF, empDF.id==teamDF.id, 'full').show()
